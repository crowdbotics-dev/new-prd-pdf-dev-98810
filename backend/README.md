...
## Project Structure
    ...
    ├── new_prd_pdf_dev_98810  # Django project configurations
...
1. Clone this repo and `cd new_prd_pdf_dev_98810`
...
2. Clone this repo and `cd new_prd_pdf_dev_98810`
