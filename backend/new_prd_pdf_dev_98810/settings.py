"""
Django settings for new_prd_pdf_dev_98810 project.
...
ROOT_URLCONF = 'new_prd_pdf_dev_98810.urls'
...
WSGI_APPLICATION = 'new_prd_pdf_dev_98810.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_prd_pdf_dev_98810 API",
    "DESCRIPTION": "API documentation for new_prd_pdf_dev_98810 App",
    "VERSION": "v1",
}
